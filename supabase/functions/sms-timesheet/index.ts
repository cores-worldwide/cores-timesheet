...
• APP — link to your mobile timesheet
...
Start your text with: "This is Joey" so the hours land on their timesheet, not yours.`,
  ...
  app: `APP — check your week

Text APP any time for the link to your mobile timesheet:
${MOBILE_URL}
...
HELP_TOPICS.mobile = HELP_TOPICS.app
...
Deno.serve(async (req: Request) => {
  ...
  if ((msgLower === 'app' || msgLower === 'mobile') && mediaUrls.length === 0) {
